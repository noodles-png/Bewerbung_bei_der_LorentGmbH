...
def main() -> None:
    pc = Bewerber(
        ...
        backstory=(
            ...
            "sich mithilfe eines BWL-Studiums auf eine kaufmännische Karriere im Familien-Unternehmen.\n "
            ...
            "und Beziehungen führte. Sowohl seine Partnerin und als auch die Geburt seines Kindes waren Gründe\n "
            "für eine Karriere, in dem Bereich, die ihn seit seines ersten Studiums fasziniert hat aber nicht\n "
            "realisiert hat, anzustreben und begann damit seine Umschulung bei der BBQ und das Schreiben dieser\n "
            "Bewerbung."
        ),
        quest=(
